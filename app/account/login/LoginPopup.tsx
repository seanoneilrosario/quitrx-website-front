        ...
        {smsEnabled && <form action={action} className="customer-login__form">
          {state.step === "code" ? (
            ...
            <>
              ...
              <div className="customer-login__field">
                <input id="customer-phone" name="phone" type="tel" inputMode="tel" autoComplete="tel" placeholder="+61" pattern="(?:(?:\+?61|0)[\s-]?0?)?4(?:[\s-]?\d){8}" required aria-describedby={state.error ? "customer-login-error" : "customer-login-help"} />
